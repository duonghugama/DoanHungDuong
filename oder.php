...
<body>
      <section class = "navbar">
        ...
        <div class ="logo">
                <img src="img/logo.png" alt="restaurant logo" class = "img-responisive" >
        </div>
      ...
      <div id="main">
         <div class="main_acc" id="logo1">
             <img src="img/bg.jpg" alt="lich" width="400" height="200">
         </div>
             ...
             <div id="select">
                 <form action="">
                   <fieldset >
                      ...
                      <div id="img"> 
                          <img src="img/menu-pizza.jpg" alt="photo" width="120" height="120">
                      </div>
                      <div id="price">
                       <p>Food Title</p>
                       <p>$2.3</p>
    ...
    <p>Designed by <a href="#" target="_blank">Nhân đơn giản</a></p>
            </div>
    </section>
